...
class EditBusinessDetailsScreen extends GetView<EditBusinessDetailsController> {
  EditBusinessDetailsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWithBackButton(
          title: kLabelEditBusinessDetails, isShowLeadingIcon: true),
                ...
                return InputDecorator(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<DropdownCommonData>(
                      ...
                      isDense: true,
                      isExpanded: true,
                      style: controller.selectedState.value.id == 0
                          ? TextStyles.kTextH14GreyBold400
                          : TextStyles.kTextH14DarkGreyBold400,
                      items: controller.stateList.map((element) {
