...
class AddProductScreen extends GetView<AddProductController> {
          ...
          child: Column(
            children: [
              ...
              PrimaryButtonWidget(
                  ...
                  color: kColorPrimary,
                  buttonTitle: kLabelAdd.toUpperCase()),
            ],
          ),
        ),
      ),
  ...
  Widget productNameTextField() {
    return Focus(
      ...
      child: Obx(() {
        return Container(
          margin: const EdgeInsets.only(left: 20.0, right: 20.0, top: 4),
          child: Column(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    contentPadding: const EdgeInsets.only(
                        left: 14.0, right: 46.0, bottom: 0, top: 1),
  ...
  Widget sellingPriceAndTaxSwitchContainer() {
    return Container(
      // height: controller.sellingPriceStr.value != '' ? 112 : 58,
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    alignLabelWithHint: true,
                    contentPadding:
                    const EdgeInsets.only(left: 14.0, bottom: 1, top: 1),
  ...
  Widget taxSwitch() {
    return Padding(
      padding: EdgeInsets.only(
        // bottom: controller.sellingPriceStr.value != '' ? 55 : 0,
      ),
      child: Row(
        children: [
          Padding(
                        ...
                        SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              alignLabelWithHint: true,
                              contentPadding: const EdgeInsets.only(
                                  left: 14.0, right: 46.0, bottom: 11, top: 11),
